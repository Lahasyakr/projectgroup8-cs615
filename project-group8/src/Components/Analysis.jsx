...
function Analysis() {
    ...
    return (
        <>
            ...
            <Grid p={7}>
                <Typography variant="body1" color="textPrimary" align="left"><u><b>User Analysis</b></u>  </Typography>
                ...
                <Typography variant="body1" color="textPrimary" align="left"> <b><u>Heirarchical Task Analysis</u></b>:
